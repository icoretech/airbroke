  ...
  return (
    <span className="relative flex h-2 w-2">
      <svg
        viewBox="0 0 6 6"
        aria-hidden="true"
        className={clsx('absolute h-full w-full', fillClasses[color], 'animate-ping')}
      >
        <circle r={3} cx={3} cy={3} />
      </svg>
      <svg viewBox="0 0 6 6" aria-hidden="true" className={clsx('relative h-full w-full', fillClasses[color])}>
        <circle r={3} cx={3} cy={3} />
      </svg>
    </span>
  );
