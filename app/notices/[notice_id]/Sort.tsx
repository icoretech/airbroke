// app/notices/[notice_id]/Sort.tsx
...
export default function Sort() {
  ...
  // Defaults must mirror backend query defaults in lib/queries/occurrences.ts
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size="sm" aria-label="Sort occurrences">
